...
/******/ 			var chunk = require("./chunks/" + ({"0":"home","1":"privacy","2":"about","3":"register","4":"not-found","5":"login"}[chunkId]||chunkId) + ".js");
  ...
  _createClass(Html, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("html", {
        ...
        content: "ie=edge"
      }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("title", null, title), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("meta", {
        name: "description",
        content: description
      }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("meta", {
        name: "viewport",
...
var routes = {
  ...
  children: [{
    path: '',
    load: function load() {
      return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 52));
    }
  }, {
    path: '/login',
    load: function load() {
    ...
    path: '/register',
    load: function load() {
      return __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 55));
    }
  }, {
    path: '/about',
    load: function load() {
